            ...
            <Card className="shadow">
              <CardHeader className="border-0">
                <Media className="align-items-center">
                  <RegisterPatient buttonLabel="Registrar Paciente"></RegisterPatient>
                </Media>
              </CardHeader>
                    ...
                    <tr key={item.id}>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          <span className="mr-2">
                            {item.porcientoTreatmentComplete + "%"}
                          </span>
                          <div>
                            <Progress
                              max="100"
                              ...
                              barClassName={
                                item.porcientoTreatmentComplete < 90
                                  ? "bg-danger"
                                  : item.porcientoTreatmentComplete < 100
                                  ? "bg-info"
                                  : "bg-success"
                              }
                            />
